...
$checks = @(
  ...
  @{ Name = 'sidebar renders personal profile card'; Ok = ($themePages | Where-Object { $_ -match 'sidebar-profile-card' -and $_ -match '>koi<' -and $_ -match 'https://linux.do/u/koi_alkaid/summary' }).Count -eq $themePages.Count },
