...
$checks = @(
  ...
  @{ Name = 'comment section keeps a fixed 28rem height with internal scrolling'; Ok = $cssText -match '\.article-comments-frame\{[^}]*max-height:\s*28rem[^}]*overflow:\s*auto[^}]*scrollbar-width:\s*thin' },
